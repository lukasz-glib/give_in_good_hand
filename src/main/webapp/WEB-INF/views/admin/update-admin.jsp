...
<section class="login-page">
    <h2>Edycja konta Administratora</h2>
    <form:form method="post" modelAttribute="updateAdmin">
        <form:hidden path="id"/>
        ...
        <div class="form-group">
            <form:password showPassword="false" path="repassword" name="password2" placeholder="Powtórz nowe hasło" required="true"/>
        </div>

        <div class="form-group form-group--buttons">
            <a href="/login" class="btn btn--without-border">Zaloguj się</a>
            <button class="btn" type="submit">Edytuj konto Admina</button>
        </div>
        <form:errors path="*"/>
    </form:form>
</section>
