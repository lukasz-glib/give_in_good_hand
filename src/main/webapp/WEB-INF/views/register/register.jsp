...
<section class="login-page">
    ...
    <form:form method="post" modelAttribute="registrationData">
        ...
        <div class="form-group">
            <form:password path="password" name="password" placeholder="Hasło" required="true"/>
        </div>
        <div class="form-group">
            <form:password path="repassword" name="password2" placeholder="Powtórz hasło" required="true"/>
        </div>
